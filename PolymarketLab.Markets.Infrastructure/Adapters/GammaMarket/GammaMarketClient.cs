    ...
    public sealed class GammaMarketClient(HttpClient httpClient) : IExternalMarketGateway
    {
        ...
        private static Result<ExternalMarket, Error> MapMarket(GammaMarketDto gammaMarket)
        {
            ...
            return new ExternalMarket(
                ...
                gammaMarket.CreatedAt,
                gammaMarket.AcceptingOrdersTimestamp,
                gammaMarket.StartDate,
                gammaMarket.EventStartTime,
                gammaMarket.EndDate,
                gammaMarket.ClosedTime,
                gammaMarket.UmaResolutionStatus,
        ...
        private sealed record GammaMarketDto(
            ...
            [property: JsonPropertyName("acceptingOrdersTimestamp")] DateTimeOffset? AcceptingOrdersTimestamp,
            [property: JsonPropertyName("startDate")] DateTimeOffset? StartDate,
            [property: JsonPropertyName("eventStartTime")] DateTimeOffset? EventStartTime,
