...
public sealed class GammaMarketClientTests
{
    ...
    public async Task GetByMarketSlugAsync_WithValidResponse_ShouldMapExternalMarket()
    {
        ...
        result.Value.Should().BeEquivalentTo(new ExternalMarket(
            ...
            ExternalCreatedAt: DateTimeOffset.Parse("2025-12-01T00:00:00Z"),
            OrdersOpenedAt: DateTimeOffset.Parse("2025-12-15T00:00:00Z"),
            GammaStartDate: DateTimeOffset.Parse("2026-01-01T00:00:00Z"),
            EventStartsAt: DateTimeOffset.Parse("2026-01-01T00:05:00Z"),
            EventEndsAt: DateTimeOffset.Parse("2026-02-01T00:00:00Z"),
            ExternalClosedAt: DateTimeOffset.Parse("2026-02-01T00:01:00Z"),
        ...
        bool includeAcceptingOrders = true)
    {
        var payload = new Dictionary<string, object?>
        {
            ...
            ["acceptingOrdersTimestamp"] = "2025-12-15T00:00:00Z",
            ["startDate"] = "2026-01-01T00:00:00Z",
            ["eventStartTime"] = "2026-01-01T00:05:00Z",
            ["endDate"] = "2026-02-01T00:00:00Z",
            ["closedTime"] = "2026-02-01T00:01:00Z",
            ["umaResolutionStatus"] = "resolved",
            ["active"] = true,
            ["closed"] = false,
