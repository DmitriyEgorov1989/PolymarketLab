...
- Когда пользователь просит изучить или взять задачу, сначала объясни её назначение простыми словами и приведи конкретные примеры успешного, ожидающего и ошибочного сценариев. Для числовых значений явно указывай смысл и единицы, например цену `0.01`, вероятность `1%` или terminal settlement `1.00`.
